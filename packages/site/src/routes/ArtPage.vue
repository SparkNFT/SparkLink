			...
			<div class="detail-container">
				...
				<div class="info">
					...
					<div>
						...
						<button class="btn white" @click="showPoster = true">POSTER SHARING</button>
					</div>
					<p class="notes">💡Everyone can view and purchase this work by sharing links or posters to the details page of the work.</p>
				</div>
			</div>
		</div>
		<Poster
