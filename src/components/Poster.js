...
const Poster = (props) => {
	...
	const { str, addr, share, coverImg, env, name, classes, t} = props;
	const splited = env.split(' ')
	const wallet = splited[0]
	const chain = splited[1]
	const imgHeight = getHeight()
	...
	return (
		<div style={{display: display}}>
			<img crossOrigin="anonymous" alt="poster" width="auto" height={imgHeight} ref={imgRef}  />
...
export default withTranslation()(withStyles(withCommon(styles), { withTheme: true })(Poster))